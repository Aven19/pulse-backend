...
class VendorRetailReports:
    '''class for getting vendor retail reports from sp-apis'''

    @staticmethod
    @api_time_logger
    @token_required
    def create_vendor_retail_report(user_object, account_object):
        """create vendor retail report using sp-apis"""
        ...
        try:
            ...
            AzReport.add(account_id=account_id, seller_partner_id=asp_id,
                         type='GET_VENDOR_REAL_TIME_INVENTORY_REPORT', reference_id=response['reportId'])
    ...
    @api_time_logger
    @token_required
    def verify_vendor_retail_report(user_object, account_object):
    ...
    @api_time_logger
    @token_required
    def get_vendor_retail_report(user_object, account_object):
